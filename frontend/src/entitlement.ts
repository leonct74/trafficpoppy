...
import { host, TRUE_REACH_PRODUCT, type PurchaseInfo } from "./host";
...
export function useEntitlement(target: string | undefined, productId = TRUE_REACH_PRODUCT): Entitlement {
